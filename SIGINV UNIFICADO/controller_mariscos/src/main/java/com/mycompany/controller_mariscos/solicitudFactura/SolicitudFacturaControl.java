...
public class SolicitudFacturaControl implements ISolicitudFacturaControl {
    ...
    private SolicitudFactura convertirADominio(SolicitudFacturaDTO dto) {
        ...
        // Corregido: getOrden_id() en lugar de getIdPedido()
        // Corregido: convertir String a ObjectId
        if (dto.getOrden_id() != null) {
            solicitud.setOrden_id(new ObjectId(dto.getOrden_id()));
        }
        ...
        // Corregido: getEstado() en lugar de getEstadoFactura()
    ...
    private SolicitudFacturaDTO convertirADTO(SolicitudFactura solicitud) {
        ...
        // Corregido: setOrden_id() en lugar de setIdPedido()
        // Corregido: convertir ObjectId a String
        dto.setOrden_id(solicitud.getOrden_id() != null ? solicitud.getOrden_id().toHexString() : null);
        ...
        // Corregido: setEstado() en lugar de setEstadoFactura()
    ...
    public boolean existeSolicitudParaOrden(String idOrden) throws Exception {
       return dao.existeSolicitudParaOrden(idOrden);
    }
}
